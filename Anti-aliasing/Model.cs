...
using Assimp;
using System.Linq;
using static Anti_aliasing.Mesh;
...
namespace Anti_aliasing
{
    class Model
    {
        ...
        private Mesh processMesh(Assimp.Mesh mesh, Scene scene)
        {
            ...
            List<Anti_aliasing.Mesh.Texture> textures = new List<Anti_aliasing.Mesh.Texture>();
            ...
            if (mesh.MaterialIndex > 0)
            {
                ...
                List<Anti_aliasing.Mesh.Texture> diffuseMaps = loadMatericalTextures(material, TextureType.Diffuse, "diffuse");
                for (int i = 0; i < diffuseMaps.Count; i++)
                {
                    textures.Insert(textures.Count, diffuseMaps[i]);
                }
                List<Anti_aliasing.Mesh.Texture> specularMaps = loadMatericalTextures(material, TextureType.Specular, "specular");
        ...
        /// <returns></returns>
        private List<Anti_aliasing.Mesh.Texture> loadMatericalTextures(Material material, TextureType type, string typename)
        {
