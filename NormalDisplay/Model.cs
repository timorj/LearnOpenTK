...
using Assimp;
using System.Linq;
using static NormalDisplay.Mesh;
...
namespace NormalDisplay
{
    class Model
    {
        ...
        private Mesh processMesh(Assimp.Mesh mesh, Scene scene)
        {
            ...
            List<NormalDisplay.Mesh.Texture> textures = new List<NormalDisplay.Mesh.Texture>();
            ...
            if (mesh.MaterialIndex > 0)
            {
                ...
                List<NormalDisplay.Mesh.Texture> diffuseMaps = loadMatericalTextures(material, TextureType.Diffuse, "diffuse");
                for (int i = 0; i < diffuseMaps.Count; i++)
                {
                    textures.Insert(textures.Count, diffuseMaps[i]);
                }
                List<NormalDisplay.Mesh.Texture> specularMaps = loadMatericalTextures(material, TextureType.Specular, "specular");
        ...
        /// <returns></returns>
        private List<NormalDisplay.Mesh.Texture> loadMatericalTextures(Material material, TextureType type, string typename)
        {
