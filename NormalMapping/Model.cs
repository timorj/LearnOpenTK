...
using Assimp;
using System.Linq;
using static NormalMapping.Mesh;
...
namespace NormalMapping
{
    class Model
    {
        ...
        private Mesh processMesh(Assimp.Mesh mesh, Scene scene)
        {
            ...
            List<NormalMapping.Mesh.Texture> textures = new List<NormalMapping.Mesh.Texture>();
            ...
            if (mesh.MaterialIndex > 0)
            {
                ...
                List<NormalMapping.Mesh.Texture> diffuseMaps = loadMatericalTextures(material, TextureType.Diffuse, "diffuse");
                for (int i = 0; i < diffuseMaps.Count; i++)
                {
                    textures.Insert(textures.Count, diffuseMaps[i]);
                }
                List<NormalMapping.Mesh.Texture> specularMaps = loadMatericalTextures(material, TextureType.Specular, "specular");
        ...
        /// <returns></returns>
        private List<NormalMapping.Mesh.Texture> loadMatericalTextures(Material material, TextureType type, string typename)
        {
