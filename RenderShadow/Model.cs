...
using Assimp;
using System.Linq;
using static RenderShadow.Mesh;
...
namespace RenderShadow
{
    class Model
    {
        ...
        private Mesh processMesh(Assimp.Mesh mesh, Scene scene)
        {
            ...
            List<RenderShadow.Mesh.Texture> textures = new List<RenderShadow.Mesh.Texture>();
            ...
            if (mesh.MaterialIndex > 0)
            {
                ...
                List<RenderShadow.Mesh.Texture> diffuseMaps = loadMatericalTextures(material, TextureType.Diffuse, "diffuse");
                for (int i = 0; i < diffuseMaps.Count; i++)
                {
                    textures.Insert(textures.Count, diffuseMaps[i]);
                }
                List<RenderShadow.Mesh.Texture> specularMaps = loadMatericalTextures(material, TextureType.Specular, "specular");
        ...
        /// <returns></returns>
        private List<RenderShadow.Mesh.Texture> loadMatericalTextures(Material material, TextureType type, string typename)
        {
