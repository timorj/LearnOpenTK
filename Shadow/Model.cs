...
namespace Shadow
{
    class Model
    {
        ...
        private Mesh processMesh(Assimp.Mesh mesh, Scene scene)
        {
            ...
            List<Shadow.Mesh.Texture> textures = new List<Shadow.Mesh.Texture>();
            ...
            if (mesh.MaterialIndex > 0)
            {
                ...
                List<Shadow.Mesh.Texture> diffuseMaps = loadMatericalTextures(material, TextureType.Diffuse, "diffuse");
                for (int i = 0; i < diffuseMaps.Count; i++)
                {
                    textures.Insert(textures.Count, diffuseMaps[i]);
                }
                List<Shadow.Mesh.Texture> specularMaps = loadMatericalTextures(material, TextureType.Specular, "specular");
        ...
        /// <returns></returns>
        private List<Shadow.Mesh.Texture> loadMatericalTextures(Material material, TextureType type, string typename)
        {
